...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_feedback = 10;
    private double nbr_reclamation = 9;
    ...
    private void addButton(Image img, String title) {
        ...
        image.addActionListener(e -> {
            try {
                new EquipeForm(Resources.getGlobalResources()).show();
            } catch (Exception exx) {

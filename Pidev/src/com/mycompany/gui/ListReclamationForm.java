...
public class ListReclamationForm extends BaseForm {
    ...
    public ListReclamationForm(Resources res) {
       ...
       addTab(swipe, s1, res.getImage("BackgroundRect.png"), "", "", res);
        ...
        RadioButton mesListes = RadioButton.createToggle("Listes", barGroup);
        ...
        mesListes.addActionListener((e) -> {
         ...
         partage.addActionListener((e) -> {
            ...
            AddReclamationForm addRec = new AddReclamationForm(res);
            addRec.show();
            refreshTheme();
        });
        ...
        ArrayList<Reclamation> list = ReclamationServices.getInstance().affichageReclamations();

        for (Reclamation rec : list) {
            String urlImage = "arrow.png";//image statique pour le moment ba3d taw fi  videos jayin nwarikom image 
    ...
    private void addButton(Image img, Reclamation rec, Resources res) {
        ...
        Label descriptionTxt = new Label("Description : " + rec.getDescriptionR());
        Label typeTxt = new Label("type : " + rec.getType());
        Label etatTxt = new Label("etat : " + rec.getEtat());
        Label DateTxt = new Label("date : " + rec.getDateR());
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            System.out.println(rec.getId_reclam());
            //n3ayto l suuprimer men service Reclamation
            if (ReclamationServices.getInstance().deleteReclamation(rec.getId_reclam())) {

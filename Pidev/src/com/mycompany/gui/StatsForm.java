...
public class StatsForm extends BaseForm {
    ...
    private double nbr_de_publication = 29;
    ...
    public StatsForm(Resources res) {
        ...
        addTab(swipe, res.getImage("extreme_background.jpg"), spacer1, "Bienvenue");
    ...
    private void addButton(Image img, String title) {
        ...
        image.addActionListener(e -> {
            try {
                new addpublicationform(Resources.getGlobalResources()).show();
            } catch (Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_feedback + nbr_de_publication;

        //values
        double prcntFeed = (nbr_feedback * 100) / total;

        double prcntRec = (nbr_de_publication * 100) / total;
        ...
        String[] messages = {
            "Statistique Commentaire % Publications"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Publication", prcntRec);
        series.add("Commentaire", prcntFeed);
